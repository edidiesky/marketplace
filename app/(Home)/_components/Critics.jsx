      ...
      >
        <div className="flex-1 imageContent">
          <img
            ...
            className="w-100 h-100 imagewrapper1"
            alt=""
          />
        </div>
        <div className="CriticsRight flex item-center justify-center">
          <div className="flex CriticsRightC column gap-4 auto">
            <h4 className="fs-18 family1 uppercase text-white">
              MEGGY STEWART
            </h4>
            <h2 className="font-mono text-white">NEW YORK TIMES</h2>
      ...
      >
        <div className="CriticsRight1 flex item-center justify-center">
          ...
          <div className="flex CriticsRightC column gap-4 auto">
            ...
            <h2 className="font-mono text-white">THE GUARDIAN</h2>
            <h4 className="fs-18 family2 text-light text-white">
              Pellentesque vitae viverra risus, sagittis. Venenatis ridiculus
              scelerisque nisi in urna nulla.
            </h4>
        ...
        <div className="CriticsRight1 flex item-center justify-center">
          ...
          <div className="flex CriticsRightC column gap-4 auto">
            ...
            <h2 className="font-mono text-white">GLOBE AND MAIL</h2>
            <h4 className="fs-18 family2 text-light text-white">
